---
title: Federation & crowdsourced-DB architecture
description: How cleanyfin achieves subsidiarity and anti-lock-in "federation" with the proven SponsorBlock hub-plus-mirrors model, deferring heavy S2S protocols.
sidebar:
  order: 4
---
