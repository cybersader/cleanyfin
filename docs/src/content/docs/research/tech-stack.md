---
title: Tech stack & easy-setup DevOps
description: The single-static-binary Go server + SQLite + one docker-compose golden path that makes cleanyfin a 5-minute, low-maintenance self-host.
sidebar:
  order: 5
---
